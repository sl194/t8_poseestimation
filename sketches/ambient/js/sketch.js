...
export function initSketchGui(gui) {
  ...
  createSectionFolder(section6, sketchGuiState.section6);
    ...
    let section7 = gui.addFolder('Section 7');
  createSectionFolder(section7, sketchGuiState.section7);
    
    let section8 = gui.addFolder('Section 8');
  createSectionFolder(section8, sketchGuiState.section8);
    
    let section9 = gui.addFolder('Section 9');
  createSectionFolder(section9, sketchGuiState.section9);
    
    let section10 = gui.addFolder('Section 10');
  createSectionFolder(section10, sketchGuiState.section10);
  ...
  let allSections = [
    ...
    sketchGuiState.section6,
      sketchGuiState.section7,
      sketchGuiState.section8,
      sketchGuiState.section9,
      sketchGuiState.section10,
  ];
}
...
//    console.log(guiSection);
//    sketchGuiState.guiSection.push(guiSection);
}
...
//          console.log(currentSectionIndex);
          console.log(currentSectionLeftX);
    ...
    if (currentSection) {
      if (parts && controlPoint.score > 0.5) {
        ...
        ctx.fillRect(currentSectionLeftX, 0, canvas.width/(sectionWidth/15), canvas.height);
