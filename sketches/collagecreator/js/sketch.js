...
//import bgimage0 from '../assets/garden.png';
...
//bgimage.src = bgimage0;

var image = document.images[0];
var downloadingImage = new Image();
downloadingImage.onload = function(){
    image.src = this.src;};
downloadingImage.src = "../assets/garden.png";
...
//  backgroundColor: '#ffffff',
    backgroundImage: downloadingImage,
...
//  gui.addColor(sketchGuiState, 'backgroundColor');
  gui.add(sketchGuiState, 'backgroundImage');
...
//  ctx.fillStyle = sketchGuiState.backgroundColor;
  ctx.fillStyle = sketchGuiState.backgroundImage;
